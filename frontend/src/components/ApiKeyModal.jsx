  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      <div className="card w-full max-w-xl max-h-[90vh] overflow-y-auto">
        ...
        {/* AI Provider section — only shown on AI tab */}
        {activeTab === 'ai' && (
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2 p-3 bg-white/5 rounded-xl">
                  ...
                  <p className="text-xs text-white/40 leading-relaxed">
                    Your key is stored <strong className="text-white/60">only in this browser</strong> and sent directly to {provider.name}'s API — never to any server.
                  </p>
                </div>
              </div>
            )}
